...
num_sgl = {"0": "Zero","1": "One","2": "Two","3": "Three","4": "Four","5": "Five","6": "Six","7": "Seven","8": "Eight","9": "Nine"}
num_dbl = {"0": "Ten","1": "Eleven","2": "Twelve","3": "Thirteen","4": "Fourteen","5": "Fifteen","6": "Sixteen","7": "Seventeen","8": "Eighteen","9": "Nineteen"}
num_tns = {"2": "Twenty","3": "Thirty","4": "Fourty","5": "Fifty","6": "Sixty","7": "Seventy","8":"Eighty","9": "Ninety",}
...
# Gets the value for 3 digits > Below is where I started to have regrets
...
while True:
    ...
    try:
        usr_inp = int(input(message1))
        usr_inp1 = str(usr_inp)
        print("Ctrl + C to exit\n")
        if usr_inp > 999:
            print("I can't count that high :(")
        elif getInpLen(usr_inp1) == 1:
            print(getNumDict(num_sgl, usr_inp1))
        elif getInpLen(usr_inp1) == 2:
            getTensValue(usr_inp1)
        elif getInpLen(usr_inp1) == 3:
