...
def converter():
    ...
    user_unit2 = input('\nEnter the type of unit you would like to convert to? *feet, mile, km, yard, inch*: ').lower()
    if user_unit2 == 'feet':
        value = value / 0.3048
    ...
    question = input("\nWould you like to convert another number? yes or no: ")
    if question == "yes":
        converter()
    else:
        print("\nThank you for converting with me!")
