...
with open('east_of_the_sun_and_west_of_the_moon.txt', 'r', encoding= 'UTF-8') as east_of_the_sun_and_west_of_the_moon_file:
    contents = east_of_the_sun_and_west_of_the_moon_file.read()
...
print(f'The ARI for the East of the Sun and West of the Moon is {ari}, this corresponds to {grade_level} level of difficulty, and the suggested age range is {age_level}.')