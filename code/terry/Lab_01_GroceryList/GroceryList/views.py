...
def detail(request, question_id):
    ...
    return render(request, 'GroceryList/detail.html', {'question': question})

def results(request, question_id):
    response = "You're looking at the results of question %s."
    return HttpResponse(response % question_id)

# def is_done(request, question_id):
...
class ResultsView(generic.DetailView):
    model = Question
    template_name = 'GroceryList/results.html'
...
def is_done(request, question_id):
    ...
    try:
        ...
        return render(request, 'GroceryList/detail.html', {
            'question': question,
            'error_message': "You didn't select a choice.",
        })
    else:
        selected_choice.is_done += 1
